...
:noremap  r <ESC>:call RenameVariable()<ENTER>
:inoremap r <ESC>:call RenameVariable()<ENTER>




" These are the default key mappings
inoremap <C-z><C-e> <ESC>:call ExtractMethod()<ENTER>
inoremap <C-z><C-p> <ESC>:call LocalVariableToParameter()<ENTER>
"inoremap <A-#> <ESC>:call RenameVariable()<ENTER>
inoremap <C-z><C-d> <ESC>:call RemoveParameter()<ENTER>
inoremap <C-z><C-o> <ESC>:call ReorderParameters()<ENTER>
inoremap <C-z><C-c> <ESC>:call IntroduceConstant()<ENTER>
noremap <C-z><C-e> <ESC>:call ExtractMethod()<ENTER>
noremap <C-z><C-p> <ESC>:call LocalVariableToParameter()<ENTER>
"noremap <A-r><A-r> <ESC>:call RenameVariable()<ENTER>
noremap <C-z><C-d> <ESC>:call RemoveParameter()<ENTER>
noremap <C-z><C-o> <ESC>:call ReorderParameters()<ENTER>
noremap <C-z><C-c> <ESC>:call IntroduceConstant()<ENTER>
...
function! RenameVariable()
	...
	let newName = input("Rename from [". variableName . "] to :")
	if newName != ""
		call GotoBeginingBracketOfCurrentFunction()
		let startLine = line('.')
		exec "normal! %"
		let stopLine = line('.')
		exec startLine . ',' . stopLine . ':s/\<' . variableName . '\>/'. newName .'/gc'	
	endif
