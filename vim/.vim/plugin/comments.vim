...
exec "noremap  <silent> ". g:cmd_add_comment ." :call CommentLine()<CR>"
" key-mappings for range comment lines in visual <Shift-V> mode
exec "vnoremap <silent> ". g:cmd_add_comment ." :call RangeCommentLine()<CR>"

" key-mappings for un-comment line in normal mode
exec "noremap  <silent> ".g:cmd_remove_comment  ." :call UnCommentLine()<CR>"
" key-mappings for range un-comment lines in visual <Shift-V> mode
exec "vnoremap <silent> ". g:cmd_remove_comment ." :call RangeUnCommentLine()<CR>"
