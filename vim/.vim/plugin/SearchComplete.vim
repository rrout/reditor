...
function! SearchCompleteStart()
	...
	"cnoremap <Tab> <C-C>:call SearchComplete()<CR>/<C-R>
...
function! SearchComplete()
	...
	let l:org=&completeopt
	
	set completeopt=longest

	let b:searchcomplete = ""
	...
	if l:search == @s
		...
		"let b:searchcompletedepth = " \<C-R>=pumvisible() ? \"\\<down>\" : \"\"\<cr>"
	endif
