...
"hi Comment          ctermfg=80                                    cterm=none
...
hi String           ctermfg=111                                     cterm=none
" character constant
...
hi Symbol           ctermfg=246	                                   cterm=none
...
hi Include          ctermfg=132                                     cterm=none
" #define
...
hi StorageClass     ctermfg=32                                     cterm=none
" struct, union, enum
hi Structure        guifg=#93e690                                   gui=none
hi Structure        ctermfg=143                                     cterm=none
" typedef
...
hi cCustomScope     ctermfg=4                                   cterm=bold
hi cCustomClass     ctermfg=10                                  cterm=bold
hi cCustomParen     ctermfg=9                                   cterm=none
...
hi MatchParen       ctermfg=255              ctermbg=165             cterm=none
...
hi DiffAdd          ctermfg=fg              ctermbg=24
" changed line
hi DiffChange       guifg=fg                guibg=#008b00
hi DiffChange       ctermfg=fg              ctermbg=94
" deleted line
hi DiffDelete       guifg=fg                guibg=#000000
hi DiffDelete       ctermfg=fg              ctermbg=232
" changed text within line
hi DiffText         guifg=fg				guibg=#000000
hi DiffText         ctermfg=fg				ctermbg=52
...
hi Search                                    ctermbg=180            cterm=none
...
highlight GtagsOutputFile cterm=bold  ctermbg=none ctermfg=32
highlight GtagsOutputLine cterm=bold  ctermbg=none ctermfg=94
highlight GtagsOutputFunction cterm=bold  ctermbg=none ctermfg=29
