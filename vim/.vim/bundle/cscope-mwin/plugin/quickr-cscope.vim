...
vnoremap <silent> <plug>(quickr_cscope_pattern)         :call <SID>quickr_cscope(<SID>get_visual_selection(), "t", "", "cs")<CR>
vnoremap <silent> <plug>(quickr_cscope_egrep_pattern)   :call <SID>quickr_cscope(<SID>get_visual_selection(), "e", "", "cs")<CR>
