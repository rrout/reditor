...
" shankar's _start_
"syn match       cFuncDecl       excludenl /^\h\w*(/me=e-1display
"syn match       cFuncDecl       excludenl /\w\s\h\w*(/me=e-1display
...
"syn match    cCustomParenR    ")" contains=cParen contains=cCppParen
"syn match    cCustomParen    "?=(" contains=cParen contains=cCppParen
...
syn region	cDefine		start="^\s*\(%:\|#\)\s*\(define\|undef\)\>" skip="\\$" end="$" end="//"me=s-1 contains=ALLBUT,@cPreProcGroup,cFunction,cAnsiFunction,@Spell
...
hi def link cCommentString	String
hi def link cComment2String	String
...
""hi Function                     cterm=bold ctermfg=Brown
"hi Function                     cterm=NONE ctermfg=173
"hi StdFunction                  cterm=bold ctermfg=70
""121
"hi Include                      cterm=bold ctermfg=132
"hi Macro                        cterm=bold ctermfg=133
"hi Statement                     cterm=None ctermfg=140
"hi Repeat                     cterm=None ctermfg=141
"hi Conditional                     cterm=None ctermfg=141
"" shankar's _end_
""hi PreCondit              guifg=#aaafcf                                   gui=none
"hi PreCondit              ctermfg=31                                      cterm=bold
"hi Type                   ctermfg=143                                     cterm=bold
"hi Structure              ctermfg=143                                     cterm=bold
"hi StorageClass           ctermfg=32                                   cterm=bold
"hi Operator               ctermfg=182                                     cterm=bold
"hi Label                  ctermfg=140                                     cterm=bold



syn keyword	cOperators	typeof __real__ __imag__  __asm__ __asm  asm sizeof __attribute__ __LINE__ __FILE__ __DATE__ __TIME__ __STDC__
"hi cOperators              ctermfg=181                                     cterm=bold

"Kals
syn match       Macro   "\<[A-Z_0-9]\+\>"
syn match       Symbol   "[=>\-+;,?|.:!<@&$%^\[\]]"
"hi Macro               ctermfg=187                                   cterm=none
"hi Symbol              ctermfg=246                                    cterm=bold
"hi cString    cterm=bold   ctermfg=111
