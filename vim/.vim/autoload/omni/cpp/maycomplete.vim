...
" May complete function for include
function! omni#cpp#maycomplete#IncludeStd()
    if s:CanUseOmnicompletion() && g:OmniCpp_MayCompleteInclude
		...
		let val = g:omni#cpp#items#data[0]["tokens"][0]["value"]
		if val == "include"
...
endfunc
" May complete function for include
function! omni#cpp#maycomplete#IncludeUsr()
    if s:CanUseOmnicompletion() && g:OmniCpp_MayCompleteInclude
        let g:omni#cpp#items#data = omni#cpp#items#Get(omni#cpp#utils#TokenizeCurrentInstruction('.'))
